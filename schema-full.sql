...
ALTER TABLE `agenda` ADD CONSTRAINT `agenda_ibfk_1` FOREIGN KEY (`paciente_id`) REFERENCES `pacientes` (`id`);
ALTER TABLE `agenda` ADD CONSTRAINT `agenda_ibfk_2` FOREIGN KEY (`profissional_id`) REFERENCES `profissionais` (`id`);

ALTER TABLE `agendamentos` ADD CONSTRAINT `agendamentos_ibfk_1` FOREIGN KEY (`paciente_id`) REFERENCES `pacientes` (`id`);
ALTER TABLE `agendamentos` ADD CONSTRAINT `agendamentos_ibfk_2` FOREIGN KEY (`profissional_id`) REFERENCES `profissionais` (`id`);

ALTER TABLE `financeiro` ADD CONSTRAINT `financeiro_ibfk_1` FOREIGN KEY (`paciente_id`) REFERENCES `pacientes` (`id`);
ALTER TABLE `financeiro` ADD CONSTRAINT `financeiro_ibfk_2` FOREIGN KEY (`profissional_id`) REFERENCES `profissionais` (`id`);

ALTER TABLE `lembretes` ADD CONSTRAINT `fk_lembretes_agenda` FOREIGN KEY (`agenda_id`) REFERENCES `agenda` (`id`) ON DELETE SET NULL;
ALTER TABLE `lembretes` ADD CONSTRAINT `lembretes_ibfk_1` FOREIGN KEY (`paciente_id`) REFERENCES `pacientes` (`id`);
ALTER TABLE `lembretes` ADD CONSTRAINT `lembretes_ibfk_2` FOREIGN KEY (`profissional_id`) REFERENCES `profissionais` (`id`);

ALTER TABLE `prontuarios` ADD CONSTRAINT `prontuarios_ibfk_1` FOREIGN KEY (`paciente_id`) REFERENCES `pacientes` (`id`);
ALTER TABLE `prontuarios` ADD CONSTRAINT `prontuarios_ibfk_2` FOREIGN KEY (`profissional_id`) REFERENCES `profissionais` (`id`);

ALTER TABLE `logs_lgpd` ADD CONSTRAINT `logs_lgpd_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`);
